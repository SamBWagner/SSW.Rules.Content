...
created: 2019-11-22T21:21:31.000Z
authors:
- title: Adam Cogan
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad Example - FILENAME Parameter used to specify database path",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good Example - Generic CREATE DATABASE used",
  shouldDisplay: true
} } />
