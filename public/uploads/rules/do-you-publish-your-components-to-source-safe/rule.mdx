...
created: 2009-12-04T08:39:07.000Z
authors:
  - title: Adam Cogan
...
1. In Visual Studio.NET, Switch to release build
   ![Build Release](/uploads/rules/do-you-publish-your-components-to-source-safe/build_release.jpg) Figure: Switch to release configuration
