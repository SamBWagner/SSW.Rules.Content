...
<youtubeEmbed url="https://www.youtube.com/embed/pwVSWCSsWOU" description={"Video: ✨ UI Update - Relocate Delete Project Button (1 min)"} />
...
<youtubeEmbed url="https://www.youtube.com/embed/Zog5y3OdDXs" description={"Video: 🐛 Bug - UI Button Color and Behavior Consistency (1 min)"} />
