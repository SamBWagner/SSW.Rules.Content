...
created: 2025-10-07T00:00:19.000Z
guid: 5108d3ab-432f-4dbf-8bbf-02065d8661de

lastUpdated: 2025-10-08T04:13:07.000Z
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - Wrong color for a destructive button",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Red is the right color for a destructive button",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - Cross icon usually means \"Cancel\" and should be avoided for permanent deletion. The icon is also wrongly positioned on the right",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Trash/Bin icon positioned on the left",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - \"Delete\" and \"Save\" are too close together can lead to accidental clicks",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - \"Delete\" button in red, with the right icon, andvisually isolated from safe actions",
    shouldDisplay: true
  } }
