...
related:
  ...
  - password-manager
redirects:
created: 2023-08-23T22:15:02.000Z
archivedreason: null
...
<imageEmbed
  ...
  src="/uploads/rules/enterprise-secrets-in-pipelines/repo-secrets.png"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/enterprise-secrets-in-pipelines/org-secrets.png"
/>
...
<figureEmbed figureEmbed={ {
  preset: "okExample",
  figure: "Listing: Secrets stored in a dedicated Key Vault in Azure and used by workflows across the organization",
  shouldDisplay: true
} } />
...
<imageEmbed
  ...
  src="/uploads/rules/enterprise-secrets-in-pipelines/enterprise-secrets.jpg"
/>
