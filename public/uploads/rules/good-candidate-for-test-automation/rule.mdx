...
created: 2023-08-17T21:44:23.000Z
...
<imageEmbed
  ...
  src="/uploads/rules/good-candidate-for-test-automation/to-automate-or-not-ssw.jpg"
/>
...
<youtubeEmbed url="https://www.youtube.com/embed/pQPUs9uaKUM" description={"Video: What is automated testing? Beginner intro & automation demo (watch from 5:30 – 7:10)"} />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - Testing a Sidebar",
  shouldDisplay: true
} } />
