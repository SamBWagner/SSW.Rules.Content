...
created: 2017-11-07T00:02:48.000Z
authors:
  - title: Adam Cogan
...
lastUpdated: 2022-11-12T00:15:56.000Z
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - Does not match requirements",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - Does not match requirements, expensive",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - Does not match requirements, quite expensive",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - Match requirements",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - Match requirements, but expensive",
  shouldDisplay: true
} } />
