...
created: 2024-06-17T07:33:52.000Z
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - Duplicated query logic to fetch the customer",
  shouldDisplay: true
} } />
...
Steve Smith (aka ["Ardalis"])([https://github.com/ardalis](https://github.com/ardalis)) has created an excellent library called [Ardalis.Specifications](https://github.com/ardalis/Specification) that integrates well with EF Core.
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Specification used to keep Order query logic DRY",
  shouldDisplay: true
} } />
