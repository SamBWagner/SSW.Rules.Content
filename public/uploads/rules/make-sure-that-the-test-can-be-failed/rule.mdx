...
lastUpdated: 2024-06-21T16:59:25.000Z
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example: The test fails by throwing a `NotImplementedException`",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example: The test fails by returning an invalid value",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example: The test fails by returning an invalid result or throwing a `NotImplementedException()` with a `//TODO:` item",
  shouldDisplay: true
} } />
