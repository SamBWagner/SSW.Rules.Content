...
created: 2025-07-25T06:40:57.000Z
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - Use out of the box replacements: [Where are the Content editor and Script editor web parts in SharePoint?](https://support.microsoft.com/en-us/office/where-are-the-content-editor-and-script-editor-web-parts-in-sharepoint-ed6cc9ce-8b2a-480c-a655-1b9d7615cdbd)",
  shouldDisplay: true
} } />
