...
created: 2016-08-11T17:30:05.000Z
archivedreason: null
guid: a006213a-e97b-46a7-a66b-beb52b205533
lastUpdated: 2025-06-10T16:37:34.000Z
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Playful branding turns an error case into a less negative experience",
    shouldDisplay: true
  } }
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Wildcard routing of unrecognised paths",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - The custom 404 html page",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - The custom 404 pages",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - The default code on web.config",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - The custom code in the web.config",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Turning on \"customErrors\" protects sensitive information against Hacker",
  shouldDisplay: true
} } />
