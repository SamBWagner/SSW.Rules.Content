...
created: 2009-12-04T08:53:06.000Z
authors:
  - title: Adam Cogan
...
![](/uploads/rules/do-you-always-say-option-strict-on/OptionStrictOff_Newsmall.gif)
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure:Bad Example – Option Strict is Off",
  shouldDisplay: true
} } />

![](/uploads/rules/do-you-always-say-option-strict-on/OptionStrictOn_Newsmall.gif)
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure:Good Example – Option Strict is On",
  shouldDisplay: true
} } />
