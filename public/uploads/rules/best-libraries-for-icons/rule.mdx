...
created: 2014-06-18T05:03:35.000Z
authors:
  - title: Ben Cull
...
* [The Azure icon collection](http://code.benco.io/icon-collection/) is an awesome set of icons if you are using Azure. Instead of browsing individually, you can also download the entire up-to-date set from the [Azure Architecture Center](https://learn.microsoft.com/en-us/azure/architecture/icons/#icon-terms?WT.mc_id=AZ-MVP-33518).
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - Using images as icons generates a lot of pain",
    shouldDisplay: true
  } }
  src="/uploads/rules/best-libraries-for-icons/23-06-2014 11-20-02 AM.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - A 5x scaled paper plane icon on the web",
    shouldDisplay: true
  } }
  src="/uploads/rules/best-libraries-for-icons/18-06-2014 2-33-45 PM.png"
/>
