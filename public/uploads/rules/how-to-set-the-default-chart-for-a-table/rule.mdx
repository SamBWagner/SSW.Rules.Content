...
created: 2021-02-08T15:59:40.000Z
authors:
...
<imageEmbed
  ...
  src="/uploads/rules/how-to-set-the-default-chart-for-a-table/default-chart-1.png"
/>
...
![](/uploads/rules/how-to-set-the-default-chart-for-a-table/default-chart-2.png)

2. If changing the default chart to Leads by Source, select chart and export it

![](/uploads/rules/how-to-set-the-default-chart-for-a-table/default-chart-3.png)
...
![](/uploads/rules/how-to-set-the-default-chart-for-a-table/default-chart-4.png)

4. Import the modified XML back into the Advanced Chart Editor and publish the changes

![](/uploads/rules/how-to-set-the-default-chart-for-a-table/default-chart-5.png)

5. Refresh the Table view, the updated chart should be the default chart in the list

![](/uploads/rules/how-to-set-the-default-chart-for-a-table/default-chart-6.png)
...
<imageEmbed
  ...
  src="/uploads/rules/how-to-set-the-default-chart-for-a-table/default-chart-7.png"
/>
