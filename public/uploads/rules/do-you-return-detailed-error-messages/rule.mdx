...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - The error message does not contain information that can be acted upon",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - The error message provides explicit detail and a short description on how to fix the issue",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - this level of data should not be returned in a production environment",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - No tracking or correlation ID is provided",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good exmaple - A error ID is provided as part of the reponse",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - No help link provided",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - A help link is provided as part of the response",
  shouldDisplay: true
} } />
