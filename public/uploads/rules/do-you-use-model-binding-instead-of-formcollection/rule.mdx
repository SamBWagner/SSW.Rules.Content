...
related: []
redirects: []
created: 2013-03-07T18:18:38.000Z
archivedreason: null
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example – Manually reading form values and assigning them to properties is tedious boiler-plate code!",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example – Using MVC’s model binding allows you to work with an automatically-populated object instead",
  shouldDisplay: true
} } />
