...
created: 2024-06-17T04:22:12.000Z
archivedreason: null
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - A client-side redirect achieved by returning a meta refresh",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Server-side redirects using middleware in Next JS",
  shouldDisplay: true
} } />
