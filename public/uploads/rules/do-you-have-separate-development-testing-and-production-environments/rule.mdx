...
created: 2009-12-04T07:57:27.000Z
authors:
  - title: Adam Cogan
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad Example - using scripts to deploy your product to different environments",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good Example - use DevOps tools and IaC to deploy to different environments",
  shouldDisplay: true
} } />
...
![](/uploads/rules/do-you-have-separate-development-testing-and-production-environments/WordColorPallete.gif)
...
![](/uploads/rules/do-you-have-separate-development-testing-and-production-environments/dev_test_prod_servers.gif)
