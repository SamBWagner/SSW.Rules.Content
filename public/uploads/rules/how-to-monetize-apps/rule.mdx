...
created: 2017-06-15T17:20:07.000Z
authors:
  - title: Matt Goldman
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Video: Bad example - Pokemon Go, one of the most successful mobile apps of all time, combines the freemium model with micro-transactions to exploit a vulnerable subset of users. It's incredibly effective, but unethical",
  shouldDisplay: true
} } />
