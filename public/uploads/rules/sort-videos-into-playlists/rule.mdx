...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Content is sorted into playlists that have their own unique thumbnail theme",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - People leaving YouTube after (or even while) watching one of your videos will rank you (and your content) down",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "okExample",
    figure: "OK example - People watching another video after yours will give you a little boost",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - People watching a video from your playlist are more likely to keep watching more of your videos, giving you a big boost!",
    shouldDisplay: true
  } }
