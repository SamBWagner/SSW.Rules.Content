...
created: 2018-06-28T23:13:38.000Z
authors:
  - title: Adam Cogan
...
![](/uploads/rules/do-you-reply-to-the-correct-zendesk-email/zenddddd.png)
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad Example: Adding groups with the same people twice. They will receive it twice in their inbox",
  shouldDisplay: true
} } />


![](/uploads/rules/do-you-reply-to-the-correct-zendesk-email/zendndnd.png)
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good Example: Add only one group, that goes to Zendesk and spread the ticket only once for everyone",
  shouldDisplay: true
} } />
