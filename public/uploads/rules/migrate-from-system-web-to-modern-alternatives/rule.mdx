...
created: 2023-06-06T12:07:47.000Z
related:
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - An example .NET Framework code snippet demonstrating use of HttpContext.Current in a method.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Code snippet showing the replacement of HttpContext.Current with IHttpContextAccessor in a .NET service class.",
  shouldDisplay: true
} } />
