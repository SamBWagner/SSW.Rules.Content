...
created: 2023-10-19T01:27:50.000Z
authors:
...
![Increase Security - Disable Local Authentication](/uploads/rules/appinsights-authentication/appinsights-disable-local-auth.png)
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Enable System Assigned managed identity",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Disable Local Authentication to enable Enhanced Security for Application Insights using Bicep",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Assigning Monitoring Metrics Publisher role to AppService Managed Identity using Bicep",
  shouldDisplay: true
} } />
...
<imageEmbed
  ...
  src="/uploads/rules/appinsights-authentication/appinsights-assigned-role.png"
/>
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Using Managed Identities when authenticating with Application Insights",
  shouldDisplay: true
} } />
