...
created: 2019-01-07T18:39:14.000Z
authors:
...
lastUpdated: 2022-05-19T10:33:17.000Z
...
<imageEmbed
  ...
  src="/uploads/rules/use-fluent-validation/cartoon-client-side-validation.jpg"
/>
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example: Fluent Validation uses LINQ expressions allowing the development of powerful, type-checked rulesets without needing to modify the class under validation.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good Example: Conditional validation with the .When() clause allows for complex logic such as “Discount number cannot be 0 if the HasDiscount boolean is true”",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good Example: This is the JSON returned from Fluent Validation when a validation rule fails. This is exactly the same format as what would be returned by the built-in ModelState validation.",
  shouldDisplay: true
} } />
