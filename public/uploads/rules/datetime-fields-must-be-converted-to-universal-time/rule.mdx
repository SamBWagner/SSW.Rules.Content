...
created: 2019-11-25T19:54:24.000Z
authors:
  - title: Adam Cogan
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - Using .NET DateTime to manipulate dates and times",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Using Noda Time to manipulate dates and times",
  shouldDisplay: true
} } />
