...
related: []
redirects: []
created: 2009-12-04T08:39:15.000Z
archivedreason: null
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - AssemblyFileVersion and AssemblyInformationalVersion don't support the asterisk (\\*) character",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - MSBuild will automatically set the Assembly version on build (when not using the GAC)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - The best way for Assembly versioning (when using the GAC)",
  shouldDisplay: true
} } />
