...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - Making a user select the parameters before seeing the data",
    shouldDisplay: true
  } }
  src="/uploads/rules/avoid-showing-empty-reports/RSRulesNoEmptyReportT07.jpg"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - Empty report caused by incorrect parameter default values (probably hard coded for when the developer wrote the report in 2006)",
    shouldDisplay: true
  } }
  src="/uploads/rules/avoid-showing-empty-reports/RSRulesNoEmptyReportT7.jpg"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - This report shows initial data as the developer configure useful parameters (in this case default values for the entire month of October Note: in US date format)",
    shouldDisplay: true
  } }
  src="/uploads/rules/avoid-showing-empty-reports/RSRulesNoEmptyReportT8.gif"
/>
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - Expressions to set the date range to the current month",
  shouldDisplay: true
} } />
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - Using an Expression to set the default values.(This will not be good enough if there is no data in the current month)",
    shouldDisplay: true
  } }
  src="/uploads/rules/avoid-showing-empty-reports/RSRulesNoEmptyReportT11.jpg"
/>
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - Using a query to retrieve the last month of available data",
  shouldDisplay: true
} } />
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Using a query to set default values for report parameters",
    shouldDisplay: true
  } }
  src="/uploads/rules/avoid-showing-empty-reports/RSRulesNoEmptyReportT10.jpg"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/avoid-showing-empty-reports/RSRulesNoEmptyReportT9.jpg"
/>
