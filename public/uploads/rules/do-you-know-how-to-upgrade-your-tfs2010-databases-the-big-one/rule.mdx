...
created: 2012-06-11T00:04:57.000Z
authors:
  - title: Damian Brady
...
5. Make sure you have access to coffee while it's installing - it could take a while!
   ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/ssw-coffee.png)
...
7. Select Upgrade | Start Wizard
   ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_upgrade_existing.png)
...
10. In the Restore Database screen, Browse, then navigate to the folder with your database backups. Make sure all of them are ticked, then click Restore.
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_restore_dbs.png)
...
13. Check "By checking this box, I confirm that I have a current backup.", then click Next
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_config_db.png)
...
16. Make sure the Reporting Services instance and URLs are correct, then click Next
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_config_reporting.png)
...
18. Click List Available Databases and check the Tfs_Warehouse database is shown, then click Next
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_warehouse.png)
...
20. Provide details of the TFSService account your reports will run as then click Next
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_reports_run_as.png)
...
22. Choose "Use current SharePoint settings", then click Next
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_sharepoint.png)
23. Confirm the details on the Summary page and click Verify
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_summary.png)
...
24. Once you have all green ticks, click Configure
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_final_configure.png)
25. Have a coffee
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/ssw-coffee.png)
26. Click Next
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_upgrade_complete.png)
27. Click Close, then Close again.
28. Change the DNS entries for your TFS server to point to the new TFS 2012 server
    ![](/uploads/rules/do-you-know-how-to-upgrade-your-tfs2010-databases-the-big-one/tfs_dns.png)
