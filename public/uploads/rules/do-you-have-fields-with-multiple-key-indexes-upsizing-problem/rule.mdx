...
<introEmbed
  body={<>
![Figure: A table with fields with multiple key indexes where the total size of the fields adds to more than 450 characters](/uploads/rules/do-you-have-fields-with-multiple-key-indexes-upsizing-problem/FieldsMultipleKeyIndexes.jpg)
  </>}
/>
