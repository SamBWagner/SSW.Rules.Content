...
created: 2011-07-14T21:06:44.000Z
authors:
  - title: Adam Cogan
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example: Waterfall project - Estimating everything up front, when you know the least about what you will be doing (potentially 6 months of work).",
  shouldDisplay: true
} } />

<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example: [Scrum Project](http://www.ssw.com.au/ssw/consulting/scrum.aspx) - Only estimating the top items in the backlog, that could be reasonably done in the next Sprint (1-4 weeks of work)",
  shouldDisplay: true
} } />
