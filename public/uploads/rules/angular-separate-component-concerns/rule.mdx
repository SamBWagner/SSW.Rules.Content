...
created: 2023-10-15T22:39:35.000Z
authors:
  - title: Chris Clement
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Massive amount of code intermingling from API calls to calculation to UI binding",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Use declarative code to bind UI value",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: UI logic is separated from Data Fetching and Data Processing logic",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: All logics (data fetching, data processing, and data display) are now separated",
  shouldDisplay: true
} } />
