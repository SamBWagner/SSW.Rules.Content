...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Reducing development complexity",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Performance is better for read-intensive reports",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "When there a multiple tables in a SQL Server view",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "It is a built-in validation device",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "They have to be maintained and can potentially get out of synch",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "They can be seen as an unnecessary waste of space",
  shouldDisplay: true
} } />
