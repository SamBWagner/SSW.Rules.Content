...
created: 2024-01-15T00:31:46.000Z
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - Manually exporting PSTs is prone to errors",
    shouldDisplay: true
  } }
  src="/uploads/rules/email-do-you-use-the-best-backup-solution/exportbadexample.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good Example - An automatic, cloud-based backup solution takes snapshots of your data daily and makes it very easy to recover and restore any emails",
    shouldDisplay: true
  } }
  src="/uploads/rules/email-do-you-use-the-best-backup-solution/backupsgoodexample3.png"
/>
