...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - A string containing HTML tags will be encoded",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - HTML tags using IHtmlContent will be treated as safe HTML and not encoded",
  shouldDisplay: true
} } />
