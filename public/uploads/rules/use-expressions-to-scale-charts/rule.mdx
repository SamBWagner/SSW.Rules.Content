...
Updated - fixed by Microsoft, see [https://learn.microsoft.com/en-us/sql/reporting-services/report-design/set-a-minimum-or-maximum-on-a-gauge-report-builder-and-ssrs?view=sql-server-ver16&WT.mc_id=DP-MVP-33518](https://learn.microsoft.com/en-us/sql/reporting-services/report-design/set-a-minimum-or-maximum-on-a-gauge-report-builder-and-ssrs?view=sql-server-ver16&WT.mc_id=DP-MVP-33518)
  </>}
  figureEmbed={{
    preset: "default",
    figure: "XXX",
