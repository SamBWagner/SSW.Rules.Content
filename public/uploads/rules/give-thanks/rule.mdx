...
created: 2023-08-10T00:53:43.000Z
archivedreason: null
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Always add your signature (name and URL) when commenting. Opt for a friendly tone, like \"thanks\" instead of a more formal \"thank you\".",
  shouldDisplay: true
} } />
