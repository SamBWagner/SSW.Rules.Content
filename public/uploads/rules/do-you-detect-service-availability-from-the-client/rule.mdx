...
created: 2018-12-10T04:58:24.000Z
authors:
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Figure Bad Example: Attempted requests to Facebook, Google, and Youtube from China took a long time to timeout, adding significant delays to the rendering of this page",
    shouldDisplay: true
  } }
  src="/uploads/rules/do-you-detect-service-availability-from-the-client/BlockedDependencies_1710232021933.png"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/do-you-detect-service-availability-from-the-client/SSW.ServiceDetector.png"
/>
...
![](/uploads/rules/do-you-detect-service-availability-from-the-client/youtuberemove.png)

**Solution 2: Provide an alternative to the blocked service**

![](/uploads/rules/do-you-detect-service-availability-from-the-client/youku.png)
