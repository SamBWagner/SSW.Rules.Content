...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Video: Bad example – Ill prepared and low energy. They show you how to fix it, though (5 min)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Video: Good example - A well prepared presentation with an excellent delivery (1 hr 9 min)",
  shouldDisplay: true
} } />
...
<imageEmbed
  ...
  src="/uploads/rules/craft-and-deliver-engaging-presentations/picture3.jpg"
/>
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Video: Good example - Using silence to strengthen your message (1 min)",
  shouldDisplay: true
} } />
