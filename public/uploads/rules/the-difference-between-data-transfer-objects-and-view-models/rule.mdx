...
created: 2019-04-15T21:58:53.000Z
authors:
  - title: Jason Taylor
...
lastUpdated: 2023-09-25T06:16:42.000Z
lastUpdatedBy: Matt Goldman
lastUpdatedByEmail: matt.goldman@outlook.com
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - A DTO that encapsulates data but also includes behaviour (or logic in this case)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - A DTO that encapsulates some data",
  shouldDisplay: true
} } />
