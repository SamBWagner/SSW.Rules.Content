...
<imageEmbed
  ...
  src="/uploads/rules/use-sql-views/ViewsSqlEmployeesTable.png"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/use-sql-views/ViewsSqlTables.png"
/>
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example – Using views from the base table containing the source data",
  shouldDisplay: true
} } />
