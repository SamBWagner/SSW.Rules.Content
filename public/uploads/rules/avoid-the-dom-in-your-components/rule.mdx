...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "This component manipulates the DOM directly to show and hide the menu",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "This component sets component state, which the template can use.  It is simpler, more descriptive and easier to test",
    shouldDisplay: true
  } }
