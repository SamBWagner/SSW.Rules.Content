...
created: 2010-07-16T06:47:48.000Z
authors:
  - title: Adam Cogan
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad Example - lacking in communication details, reason for calling and sense of urgency",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good Example - This communicates important contact details, a reason for calling and implies a response is needed in the next day or so",
  shouldDisplay: true
} } />
