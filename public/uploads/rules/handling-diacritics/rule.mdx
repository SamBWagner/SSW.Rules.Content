...
created: 2024-03-14T15:47:43.000Z
authors:
  - title: Chloe Lin
...
You can also achieve the same result in .NET using a similar method [Normalize()]([https://learn.microsoft.com/en-us/dotnet/api/system.string.normalize?view=net-8.0#system-string-normalize(system-text-normalizationform&WT.mc_id=DP-MVP-33518)](https://learn.microsoft.com/en-us/dotnet/api/system.string.normalize?view=net-8.0#system-string-normalize(system-text-normalizationform&WT.mc_id=DP-MVP-33518))):
