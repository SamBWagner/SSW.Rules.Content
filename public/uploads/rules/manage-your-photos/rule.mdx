...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Add photos to Google Photos so you can organize your photos and search keywords or people's names to find things easily. It also displays thumbnails for greater visability",
    shouldDisplay: true
  } }
