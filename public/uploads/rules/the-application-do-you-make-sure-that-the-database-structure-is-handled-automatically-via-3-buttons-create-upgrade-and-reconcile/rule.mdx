...
created: 2009-10-09T06:06:25.000Z
...
![Figure: The developer thinks "what could be wrong"](/uploads/rules/the-application-do-you-make-sure-that-the-database-structure-is-handled-automatically-via-3-buttons-create-upgrade-and-reconcile/ObamaThinking.jpg)

![Figure: The developer tests then replies "Works on my machine"](/uploads/rules/the-application-do-you-make-sure-that-the-database-structure-is-handled-automatically-via-3-buttons-create-upgrade-and-reconcile/WorksOnMyMachine.png)
