...
created: 2015-09-23T18:17:11.000Z
authors:
  - title: William Yin
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - Sharing URL via Share email invite",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Get URL from SharePoint top bar",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Get URL by right-clicking a file in SharePoint",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "okExample",
    figure: "OK example - Set file sharing permission to \"People with existing access\" each time you share",
    shouldDisplay: true
  } }
