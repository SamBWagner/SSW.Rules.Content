...
created: 2025-03-20T12:22:40.000Z
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bash: Bad example - The initial JavaScript load size is quite huge and it is in the megabytes",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Code: Bad example - Importing entire module",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Code: Good example - Importing only the required function",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Bash: Good example - The First Load JavaScript size is reduced to kilobytes from megabytes.",
  shouldDisplay: true
} } />
