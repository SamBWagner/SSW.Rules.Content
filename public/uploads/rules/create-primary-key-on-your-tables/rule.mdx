...
![Bad Example - Table missing primarykey](/uploads/rules/create-primary-key-on-your-tables/sql-table-without-primary-key.png)
![Good Example - Table with primary key](/uploads/rules/create-primary-key-on-your-tables/sql-table-with-primary-key.png)
