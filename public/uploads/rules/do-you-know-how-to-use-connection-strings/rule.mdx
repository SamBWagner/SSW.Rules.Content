...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - For a complete example, refer to this [sample application](https://github.com/william-liebenberg/keyvault-example)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Historical example - Old ASP.NET 1.1 way, untyped and prone to error",
  shouldDisplay: true
} } />
...
<imageEmbed
  ...
  src="/uploads/rules/do-you-know-how-to-use-connection-strings/ConnStringNET2\_Settings.jpg"
/>
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Historical example - Access our connection string by strongly typed generated settings class...this is no longer the best way to do it",
  shouldDisplay: true
} } />
