...
created: 2020-10-21T18:35:08.000Z
archivedreason: null
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example – REST API does not return order information with a customer query, so a second API call is needed",
    shouldDisplay: true
  } }
  src="/uploads/rules/graphql-when-to-use/graphql-bad-example-underfetching.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example – REST API returns a whole bunch of data the client doesn’t need – killing bandwidth (and, on mobile, battery)",
    shouldDisplay: true
  } }
  src="/uploads/rules/graphql-when-to-use/graph-ql-bad-overfetching.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example – Clients can write queries and specify which fields they want the query to return",
    shouldDisplay: true
  } }
  src="/uploads/rules/graphql-when-to-use/graphql-good-example-shaped-query.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example – Image encoded as Base64 string uses more bandwidth and processing power than necessary, resulting in poor UX",
    shouldDisplay: true
  } }
  src="/uploads/rules/graphql-when-to-use/graphql-image-base64.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example – GraphQL used to construct a complex query with embedded entities, and images are referenced with a URI that the client can use to retrieve from a REST endpoint",
    shouldDisplay: true
  } }
  src="/uploads/rules/graphql-when-to-use/good-example-image-url.png"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/graphql-when-to-use/adam-blog-screenshot.png"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/graphql-when-to-use/people-graph-screenshot.png"
/>
