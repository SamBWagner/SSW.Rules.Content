...
created: 2024-07-18T05:23:39.000Z
guid: d84cad17-a3d0-4e1f-aaba-f2cd7c950d86
lastUpdated: 2025-02-07T20:02:23.000Z
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - We've all seen one of these 🤮",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Figure - Sample readme Generated with https://readmi.xyz/",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - Not much useful information to anyone looking to contribute to the repository",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - No information for how to contribute or use the repository",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Lots of great information for developers to know what they'd get with the SSW Clean Architecture template",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Plenty of useful information for contributors and customers of TinaCMS",
    shouldDisplay: true
  } }
