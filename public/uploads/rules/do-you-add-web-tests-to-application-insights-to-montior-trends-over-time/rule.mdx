...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - You can clearly see the point where a fix to production improved the initial page load",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Reviewing the Web test results that provides vital information",
    shouldDisplay: true
  } }
