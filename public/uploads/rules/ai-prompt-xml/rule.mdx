...
related: null
created: 2025-05-14T18:48:11.000Z
archivedreason: null
guid: 4d8e03c3-e842-4b1d-a049-8eff21b1209f
lastUpdated: 2025-05-16T02:08:42.000Z
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Code: Bad example - If it's hard for humans to read 'at-a-glance', the AI will struggle too",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Code: Good example - Markdown in your prompts clearly delineate what each part of the prompt is for",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Code: Good example - XML in your prompts makes it easier for humans and LLMs to both read, leading to higher quality and more desirable outputs",
  shouldDisplay: true
} } />
