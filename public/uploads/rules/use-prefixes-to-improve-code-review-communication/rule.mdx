...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Without a prefix, this comment's intent is vague. It's not evident whether it's a suggestion, a question, or an issue.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: The prefix \"suggestion\" indicates that the comment is a suggestion for improvement",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: The prefix \"issue\" and following context clearly define the comment's importance and category.",
  shouldDisplay: true
} } />
