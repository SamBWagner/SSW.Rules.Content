...
created: 2022-03-17T06:51:09.000Z
guid: ef89a713-c51d-45e0-8c14-2ca010eec387
lastUpdated: 2025-02-06T12:14:53.000Z
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example – The name says Adam Cogan, but the email address is a Gmail account",
    shouldDisplay: true
  } }
  src="/uploads/rules/recognizing-scam-emails/email-scam-name.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example – The email address is correct, and in this case as it’s internal, the sender’s profile picture is shown",
    shouldDisplay: true
  } }
  src="/uploads/rules/recognizing-scam-emails/good-email-example.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example – The attacker has referred to the recipient as ‘Matt’, which the sender does not call him",
    shouldDisplay: true
  } }
  src="/uploads/rules/recognizing-scam-emails/bad-language-example.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example – Easy to distinguish as the sender refers to the recipient as ‘Goldie’ and includes the sender’s signature use of emoji",
    shouldDisplay: true
  } }
  src="/uploads/rules/recognizing-scam-emails/good-language-example.png"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/recognizing-scam-emails/hard-to-catch-safelink.png"
/>
...
Visit [phishingquiz.withgoogle.com](https://phishingquiz.withgoogle.com) and test how good you are at recognizing a phishing email.
