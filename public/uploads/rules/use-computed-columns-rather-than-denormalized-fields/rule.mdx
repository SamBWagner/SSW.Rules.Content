...
![Bad Example - This field was manually updated from code in the middle tier.](/uploads/rules/use-computed-columns-rather-than-denormalized-fields/NormalizedFields_Bad.jpg)
![Good Example - There was no code in the middle tier to calculate this (and it has the correct name)](/uploads/rules/use-computed-columns-rather-than-denormalized-fields/NormalizedFields_Good.jpg)
  </>}
/>
