...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Acknowledging new participants and keeping the conversation light and engaging",
  shouldDisplay: true
} } />
