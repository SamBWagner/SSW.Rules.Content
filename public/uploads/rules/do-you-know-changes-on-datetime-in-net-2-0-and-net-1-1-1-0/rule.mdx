...
type: rule
archivedreason: Obsolete - Modern .NET versions (e.g., .NET 6 and later) provide better alternatives like DateTimeOffset and DateOnly for handling time zones and serialization.
...
created: 2009-12-04T08:40:28.000Z
authors:
  - title: Adam Cogan
