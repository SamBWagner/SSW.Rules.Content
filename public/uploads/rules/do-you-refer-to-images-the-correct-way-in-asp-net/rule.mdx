...
related: []
redirects: []
created: 2009-12-04T08:53:17.000Z
archivedreason: null
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - Referencing images with absolute paths",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - Referencing images with relative paths",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - Application-relative paths with an ASP.NET Server control",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - Page.ResolveUrl method with a non-server tag",
  shouldDisplay: true
} } />
