...
created: 2019-10-16T18:18:30.000Z
authors:
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good Example - Using one account on many systems",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good Example - Using SSO to log into CRM with your on-premises account",
  shouldDisplay: true
} } />
