...
lastUpdated: 2025-04-10T06:37:17.000Z
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example of coding practice",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example of coding practice which will result better performance",
  shouldDisplay: true
} } />
