...
created: 2022-12-14T21:50:17.000Z
archivedreason: null
guid: 985df34b-7af9-4f03-a48a-cf7391411656
lastUpdated: 2025-10-07T11:21:46.000Z
...
<imageEmbed
  ...
  src="/uploads/rules/choosing-authentication/security-icon-ssw.jpg"
/>
...
<youtubeEmbed url="https://www.youtube.com/embed/5OUQZAvxZuA?ecver=1" description={""} />
...
* **Option A** ==(Recommended)== - [Microsoft Entra ID](https://www.microsoft.com/security/business/microsoft-entra?WT.mc_id=ES-MVP-33518) provides all of the functionality you need and provides all required functionality in the free tier.
...
* **Option A** ==(Recommended)== - [Microsoft Entra ID](https://www.microsoft.com/security/business/microsoft-entra?WT.mc_id=ES-MVP-33518) (previously Azure Active Directory) - most of the infrastructure for this is already in place for you, and it already meets all your requirements. We would just need to wire up your application to it.
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - The chosen solution meets the requirements without adding unnecessary additional costs",
  shouldDisplay: true
} } />
